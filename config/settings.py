...
"""
import os
import dj_database_url # <--- Adicione este
...
# Configuração padrão (Seu PC usa SQLite)
DATABASES = {
    'default': {
...
# Se o código perceber que tem um banco de dados na nuvem disponível, ele troca:
...
USE_I18N = True
USE_TZ = True # Isso faz o banco salvar em UTC (Recomendado)
...
# Isso diz onde o WhiteNoise deve guardar os arquivos na nuvem
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Otimização do WhiteNoise
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'

# Diz ao Django para usar o nosso modelo e não o padrão
